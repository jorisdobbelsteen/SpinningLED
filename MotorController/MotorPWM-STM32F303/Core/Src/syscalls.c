...
//  while ((ret = HAL_UART_Transmit_DMA(&huart2, (const uint8_t*)ptr, len)) == HAL_BUSY) {
//    // NOTE: Tick counter might be turned off, so DO NOT USE HAL_Delay or any tick function !!!
